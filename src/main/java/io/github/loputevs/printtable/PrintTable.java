...
/**
 * todo - описать зачем, фичи(линки на api & example)
 * <p>
...
public class PrintTable<E> {
     ...
     * - locally override {@code Object.toString} for cell value. // todo - fix Object.toString display
     ...
     * @param formatter     (optional argument) cell value formatter/toStringMapper, applied for cell value. // todo - описать default argument
     * @param optionsConfig (optional argument) extra configuration for column. // todo - описать default argument
    ...
    public void toAppendable(Appendable appendable) {
        try {
            ...
            throw new RuntimeException(e); // todo - exception desc
        }
    }
    
    // todo - docs & test-example
...
// todo - doc
    ...
    public static class DefaultFormatterBuilder {
        ...
        public static Function<? super Number, String> decimal(String pattern) {
            // todo - fail-fast validate pattern
            return numberObj -> (numberObj == null)
                    ? String.valueOf((Object) null) // todo - "null"
    ...
    // todo - doc
    public static class CellColour<E> {
    ...
    public enum AlignSide {LEFT, RIGHT}
    
    /**
     * colourise string -> always add 9 char for {@code String.length()}.
     */
    public enum Colour {
        BLACK(CellColour.TEXT_BLACK),
        RED(CellColour.TEXT_RED),
        GREEN(CellColour.TEXT_GREEN),
        YELLOW(CellColour.TEXT_YELLOW),
        BLUE(CellColour.TEXT_BLUE),
        PURPLE(CellColour.TEXT_PURPLE),
        CYAN(CellColour.TEXT_CYAN),
        WHITE(CellColour.TEXT_WHITE),
        DEFAULT(CellColour.TEXT_RESET);
        
        
        private final String txtColour;
        
        private Colour(String txtColour) {
        ...
        public static String colourise(Object txt, Colour colour) {
            return colour.txtColour + txt + CellColour.TEXT_RESET;
        }
    }
